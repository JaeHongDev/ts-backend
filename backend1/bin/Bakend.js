        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                fs_1.default.readdirSync(__dirname + "/routes")
                    .filter(function (file) { return file.indexOf(".") !== 0 && file.slice(-9) === ".route.js"; })
                    .forEach(function (routeFile) { return __awaiter(_this, void 0, void 0, function () {
                    var getRoute;
                    var _a;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            case 0: return [4, Promise.resolve().then(function () { return __importStar(require("./routes/" + routeFile)); })];
                            case 1:
                                getRoute = _b.sent();
                                (_a = this.application_) === null || _a === void 0 ? void 0 : _a.use(getRoute.default.routeName, getRoute.default.set());
                                return [2];
                        }
                    });
                }); });
